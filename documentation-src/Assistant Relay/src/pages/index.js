...
const features = [
  {
    ...
    description: (
      <>
        Assistant Relay is easy to use, with a web dashboard to configure and test and a REST API to easily connect with.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Assistant Relay is Open Source.  Get involved by squashing bugs or adding features
      </>
    ),
  },
  {
    title: <>Powered by Google Assistant Service</>,
